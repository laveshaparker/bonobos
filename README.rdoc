...
- Open a terminal/console/command prompt and clone the source repository with "git clone https://github.com/catkeck/bonobos/"
- Use the console to enter the directory which you cloned the repository to
- Enter "rails s" into your console
